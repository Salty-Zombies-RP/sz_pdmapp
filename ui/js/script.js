...
window.addEventListener("load", () => {
    $.post('https://sz-pdm-app/getVehicles', JSON.stringify({}), function(data) {
        ...
        if(newInner == '') {
                    ...
                    if(categories[j].id == vehicles[i].category) {
                        let inner = `
                            <div id="vehicle-card-${vehicles[i].model}-${vehicles[i].category}" class="vehicle-card"> 
                                <img src="assets/vehicles/${vehicles[i].model}.png" onerror="this.src='assets/alt.png'"> 
                                <div class="vehicleInfo"> 
                                    <div class="vehicle-label">${vehicles[i].name}</div> 
            ...
            newInner = `<div id="all" class="category">All</div>`
